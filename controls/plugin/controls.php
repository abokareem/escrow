...
class Auth
{
    ...
    public function loginadminuser()
    {
        ...
        $findQuery = "SELECT tblid,fisrtname,lastname,username,useremail,userrole,active FROM escrowsify_tblpaymentcom WHERE username='$username' OR useremail='$username' AND userpassword='$encPassword'";
        ...
        if ($runQuery) {
            ...
            if ($counter > 0) {
                ...
                $_SESSION['useremail'] = $fetchuser['useremail'];
                $_SESSION['userrole'] = $fetchuser['userrole'];
                $_SESSION['active'] = $fetchuser['active'];
