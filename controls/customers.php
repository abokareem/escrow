                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="card-box table-responsive">
                        			...
                        			<h4 class="header-title m-t-0 m-b-30">Customer List</h4>
                                    ...
                                    <table id="datatables" class="table table-striped table-bordered">
                                        ...
                                        <tbody>
                                        <?php
                                            $selectcustomerRegisteration = "SELECT tblid,firstname,lastname,emailaddres,username,address,createdon FROM escrowsify_tblcustomer";
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $emailaddres; ?></td>
                                            <td><?php echo $username; ?></td>
                                            <td><?php echo $address; ?></td>
                                            <td><?php echo $createdon; ?></td>
                                            <td><button class="btn btn-rounded btn-danger delefuc" data-useridn="<?php echo $tblid; ?>"></button> </td>
                                        </tr>
                                        <?php } ?>
                                        </tbody>
