                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card-box table-responsive">
                            ...
                            <h4 class="header-title m-t-0 m-b-30">Transaction List</h4>
                            ...
                            <table id="datatables" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                <?php
                                $selectcustomerRegisteration = "SELECT escrowsify_tblcustomer.firstname,escrowsify_tblcustomer.lastname,escrowsify_tblproduct.productname
                                                                            escrowsify_tblproduct.productPrice,escrowsify_orders.tblid,escrowsify_orders.cancelled,escrowsify_orders.created_on FROM escrowsify_orders
                                                                            ...
                                                                            ON escrowsify_tblcustomer.tblid = escrowsify_orders=tblid";
                                ...
                                while ($row = mysqli_fetch_array($runQuery)) {
                                    ...
                                    $orderStat = $_POST['cancelled'];
                                    $createdon = $_POST['created_on'];
                                    if ($orderStat == 0) {
                                        $orderStat = "Sucessfull";
                                        $refundStat = "False";
                                    } else {
                                        $orderStat = "Cancel";
                                        $refundStat = "True";
