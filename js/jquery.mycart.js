  ...
  var loadMyCartEvent = function(userOptions){
    ...
    if(!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<button type="button" class="btn btn-default" id="chekut" >Check out</button>' +
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        $cartTable.append(
          ...
          '<td title="Remove from Cart" class="text-center" style="width: 30px;"><button href="javascript:void(0);" class="btn btn-xs btn-danger ' + classProductRemove + '">X</button></td>' +
          '</tr>'
        );
        productidn = this.id;
      });
    ...
    var showDiscountPrice = function(){
      $("#" + idDiscountPrice).html("$<span id='realprice' data-priced='"+options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity())+"'>" + options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity())+"</span>");
        // $("#" + idDiscountPrice).html("<span id='realprice' class='hidden'>" + options.getDiscountPrice(ProductManager.getAllProducts(), ProductManager.getTotalPrice(), ProductManager.getTotalQuantity())+"</span>");
    }
